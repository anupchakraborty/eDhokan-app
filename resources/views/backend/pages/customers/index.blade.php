...
@section('title')
    Customer Page | eDhokan - Admin Dashboard
@endsection
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle table-nowrap table-check">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $loop->index+1 }}</td>
                                                    <td><a href="javascript: void(0);" class="text-body fw-bold">{{ $customer->first_name }} {{ $customer->last_name }}</a> </td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-3">
                                                            ...
                                                            <a href="{{ route('admin.customer.edit', $customer->id) }}" class="text-success"><i class="fas fa-edit"></i></a>&nbsp;
                                                            @endif
                                                            @if(Auth::guard('admin')->user()->can('customer.edit'))
                                                            <a class="text-danger" href="#delete-form{{ $customer->id }}" data-toggle="modal">
                                                            <i class="fas fa-trash"></i>
                                                            </a>
                                                            @endif
                                                                @if(Auth::guard('admin')->user()->can('customer.delete'))
                                                                <!--Delete Modal -->
                                                                <div id="delete-form{{ $customer->id }}" class="modal fade">
